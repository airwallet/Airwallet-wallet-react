...
import { View, Text, StyleSheet, Platform, TouchableOpacity, Alert, Image } from 'react-native';
...
class FingurPrintScaner extends Component {
              ...
              return <View style={styles.fingerPrintCont}>
                        ...
                        <View style={styles.checkIcon}>
                            {/* <LottieView
                                ...
                                style={{height: 108, width: 110,  borderRadius: 50, }}
                                autoSize
                                autoPlay
                                loop={true}
                            /> */}
                            <MaterialIcons style={{padding: 5, backgroundColor: 'white', borderRadius: 100}} name="check" size={35} color= {colors.yellow}/>
                        </View>
                    </View>
          }else {
              return <View style={styles.fingerPrintCont}>
    ...
    render() {
        const { errorMessage, error, success, counter } = this.state;
            ...
            <Background smallTopMargin type="dark" style={styles.background}>
                ...
                <Container style={styles.container}>
                   ...
                   {sensorType === 'faceId' ? <View style={{justifyContent: 'center', alignItems: 'center'}}>
                        ...
                        <Text style={styles.faceTxt}>{Languages.SCAN_YOUR_FACE}</Text>
                    </View> : null}
