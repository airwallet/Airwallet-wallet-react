...
class DatePicker extends Component {
  ...
  getTitleElement() {
    ...
    if (!date && placeholder) {
      return (
        <Text allowFontScaling={allowFontScaling} style={[Style.placeholderText, customStyles.placeholderText, {color: '#B2B1B0'}]}>
          {placeholder}
        </Text>
      );
    }
    return (
      <Text allowFontScaling={allowFontScaling} style={Style.placeholderText}>
        {this.getDateStr()}
      </Text>
    );
  }
