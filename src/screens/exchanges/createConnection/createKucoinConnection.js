...
export default class CreateKucoinConnection extends Component {
    constructor(props) {
        super(props);
        ...
        this.state = {
            ...
            apiKey: '5c7e284fef83c7763582517b',
            apiSecret: '2bdb7113-16d7-4ca4-a91c-9847932040cf',
            passpharase: "aloktesting",
            additionalOptions: {
    ...
    loginKucoin = (data) => {
        ...
        POST(EXCHANGES.LOGIN_KUCOIN, config)
            .then((res) => {
                console.log('kucoin login res', res);
                setAsyncStorage(EXCHANGES.KUCOIN_INFO, JSON.stringify(data))
                this.props.navigation.navigate('wallets', {name: 'kucoin'});
            })
            .catch((error) => {
                console.log(error)
