...
/**
   ...
   */},{key:'resetAnimation',value:function(){function resetAnimation(
callback){
...
result[key]=_value2.__getAnimatedValue();
}else{
...
if(_value3 instanceof Animated){
_value3.__addChild(_this14);
}
}
});
}return __attach;}()},{key:'__detach',value:function(){function __detach()
...
if(_value4 instanceof Animated){
_value4.__removeChild(_this15);
}
}
});
...
var _value5=this._style[key];
if(_value5 instanceof Animated){
style[key]=_value5.__getValue();
}else{
style[key]=_value5;
}
}
...
var style={};
for(var key in this._style){
var _value6=this._style[key];
if(_value6 instanceof Animated){
style[key]=_value6.__getAnimatedValue();
}
}
return style;
}return __getAnimatedValue;}()},{key:'__attach',value:function(){function __attach()
...
{
for(var key in this._style){
var _value7=this._style[key];
if(_value7 instanceof Animated){
_value7.__addChild(this);
}
}
}return __attach;}()},{key:'__detach',value:function(){function __detach()
...
{
for(var key in this._style){
var _value8=this._style[key];
if(_value8 instanceof Animated){
_value8.__removeChild(this);
}
}
...
var _value9=this._props[key];
if(_value9 instanceof Animated){
props[key]=_value9.__getValue();
}else{
props[key]=_value9;
}
}
...
var props={};
for(var key in this._props){
var _value10=this._props[key];
if(_value10 instanceof Animated){
props[key]=_value10.__getAnimatedValue();
}
}
return props;
}return __getAnimatedValue;}()},{key:'__attach',value:function(){function __attach()
...
{
for(var key in this._props){
var _value11=this._props[key];
if(_value11 instanceof Animated){
_value11.__addChild(this);
}
}
}return __attach;}()},{key:'__detach',value:function(){function __detach()
...
{
for(var key in this._props){
var _value12=this._props[key];
if(_value12 instanceof Animated){
_value12.__removeChild(this);
}
}
